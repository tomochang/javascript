(function(e)
	e.fn.modal=function(t){
		function o(){
			...
			if(s===false){
				n.css({
					opacity:t.opacity,backgroundColor:"#"+t.background
				});
				...
				s=false;r.fadeOut(100,function(){
